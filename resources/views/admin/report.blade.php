            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="col-my-12">
                            <form action="/report" method="GET" class="d-flex flex-row justify-content-center">
                                @csrf
                        ...
                        <form action="/cetak-laporan" method="GET" target="_blank">
                            <input type="hidden" name="tahun" value="{{ $ii }}">
                            <div class="text-end upgrade-btn">
                                <button type="submit" class="btn btn-danger text-white ">Cetak</a>
                           </div>
                        </form>
